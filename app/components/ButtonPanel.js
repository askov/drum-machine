  ...
  render() {
    return (
      <div className="button-panel">
        <div role="button" className={'power-button round-button' + (this.props.power ? ' round-button--on' : '')} onClick={this.props.handlePowerClick}>
        ...
        <div role="button" className={'vol-plus round-button' + (this.props.power ? ' round-button--on' : '')}></div>
        <div role="button" className={'vol-minus round-button' + (this.props.power ? ' round-button--on' : '')}></div>
      </div>
    );
  }
}
